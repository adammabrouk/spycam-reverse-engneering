...
public class c {
    ...
    public static class b {
        ...
        public static void a(b[] bVarArr, Path path) {
            ...
            for (int i2 = 0; i2 < bVarArr.length; i2++) {
                a(path, fArr, c2, bVarArr[i2].f981a, bVarArr[i2].f982b);
                c2 = bVarArr[i2].f981a;
            }
        }
        ...
        public b(b bVar) {
            ...
            float[] fArr = bVar.f982b;
            this.f982b = c.a(fArr, 0, fArr.length);
        }
        ...
        public void a(b bVar, b bVar2, float f2) {
            ...
            while (true) {
                ...
                this.f982b[i2] = (fArr[i2] * (1.0f - f2)) + (bVar2.f982b[i2] * f2);
                i2++;
            }
        }
    ...
    public static void b(b[] bVarArr, b[] bVarArr2) {
        for (int i2 = 0; i2 < bVarArr2.length; i2++) {
            bVarArr[i2].f981a = bVarArr2[i2].f981a;
            for (int i3 = 0; i3 < bVarArr2[i2].f982b.length; i3++) {
                bVarArr[i2].f982b[i3] = bVarArr2[i2].f982b[i3];
            }
        }
    }
    ...
    public static boolean a(b[] bVarArr, b[] bVarArr2) {
        ...
        for (int i2 = 0; i2 < bVarArr.length; i2++) {
            if (bVarArr[i2].f981a != bVarArr2[i2].f981a || bVarArr[i2].f982b.length != bVarArr2[i2].f982b.length) {
                return false;
            }
        }
        return true;
    ...
    public static void a(ArrayList<b> arrayList, char c2, float[] fArr) {
    ...
    */
    public static void a(java.lang.String r8, int r9, a.h.c.c.a r10) {
        /*
            r0 = 0
            r10.f980b = r0
            r1 = r9
        ...
        L3d:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: a.h.c.c.a(java.lang.String, int, a.h.c.c$a):void");
    }
}
