...
public final class b extends i0 {
    ...
    public final void a(c.j.a.v vVar) {
        ...
        if (arrayList.size() > 0 || arrayList3.size() > 0) {
            if (arrayList.size() > 0) {
                c.j.a.m.m().a(arrayList);
            }
            c.j.a.m.m().a(sVar.d(), arrayList3.size() > 0 ? 10000 : e2);
            c.j.a.s.b(new c(this, e2, arrayList, arrayList3, d2));
        }
        if (arrayList2.size() > 0 || arrayList4.size() > 0) {
            if (arrayList2.size() > 0) {
                c.j.a.m.m().b((String) arrayList2.get(0));
            }
            c.j.a.m.m().a(sVar.d(), e2);
            c.j.a.s.b(new d(this, e2, arrayList2, arrayList4, d2));
        }
    }
}
