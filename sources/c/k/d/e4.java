...
public class e4 implements a4 {
    public final void a(Service service, Intent intent) {
        ...
        if (!TextUtils.isEmpty(stringExtra)) {
            ...
            if (!TextUtils.isEmpty(b2)) {
                t3.a(service.getApplicationContext(), b2, 1007, "play with service successfully");
                return;
            }
        }
    ...
    public final void b(Context context, w3 w3Var) {
        ...
        if (!c.k.d.p9.d1.a(context, m516a, b2)) {
        ...
        try {
            ...
            if (a2 == 1 && !x3.m523a(context)) {
                ...
                t3.a(context, d2, 1008, "A is fail to help B's service");
            } else {
            ...
            c.k.a.a.a.c.a(e2);
            t3.a(context, d2, 1008, "A meet a exception when help B's service");
        }
    }
}
