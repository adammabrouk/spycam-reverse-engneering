...
public final class UriUtils {
    ...
    */
    public static java.io.File copyUri2Cache(android.net.Uri r7) {
        /*
            java.lang.String r0 = "UriUtils"
            java.lang.String r1 = "copyUri2Cache() called"
            android.util.Log.d(r0, r1)
            r0 = 0
            android.app.Application r1 = com.shix.shixipc.utilcode.Utils.getApp()     // Catch: java.lang.Throwable -> L4a java.io.FileNotFoundException -> L4f
            ...
            android.app.Application r2 = com.shix.shixipc.utilcode.Utils.getApp()     // Catch: java.io.FileNotFoundException -> L48 java.lang.Throwable -> L5f
            ...
            com.shix.shixipc.utilcode.UtilsBridge.writeFileFromIS(r2, r7)     // Catch: java.io.FileNotFoundException -> L48 java.lang.Throwable -> L5f
            if (r7 == 0) goto L47
        ...
        L6a:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.shix.shixipc.utilcode.UriUtils.copyUri2Cache(android.net.Uri):java.io.File");
    }
    ...
    */
    public static byte[] uri2Bytes(android.net.Uri r4) {
        /*
            ...
            return r0
        L4:
            android.app.Application r1 = com.shix.shixipc.utilcode.Utils.getApp()     // Catch: java.lang.Throwable -> L21 java.io.FileNotFoundException -> L26
            ...
            byte[] r0 = com.shix.shixipc.utilcode.UtilsBridge.inputStream2Bytes(r4)     // Catch: java.io.FileNotFoundException -> L1f java.lang.Throwable -> L3d
            if (r4 == 0) goto L1e
        ...
        L48:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.shix.shixipc.utilcode.UriUtils.uri2Bytes(android.net.Uri):byte[]");
    }
    ...
    public static File uri2FileReal(Uri uri) {
        Uri uri2;
        File fileFromUri;
        boolean z;
        String str;
        ...
        if (Build.VERSION.SDK_INT < 19 || !DocumentsContract.isDocumentUri(Utils.getApp(), uri)) {
            if ("content".equals(scheme)) {
                return getFileFromUri(uri, WakedResultReceiver.WAKE_TYPE_KEY);
            }
