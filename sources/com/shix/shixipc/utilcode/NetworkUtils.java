...
public final class NetworkUtils {
    ...
    public static final class NetworkChangedReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            if ("android.net.conn.CONNECTIVITY_CHANGE".equals(intent.getAction())) {
                UtilsBridge.runOnUiThreadDelayed(new Runnable() { // from class: com.shix.shixipc.utilcode.NetworkUtils.NetworkChangedReceiver.3
        ...
        public void registerListener(final OnNetworkStatusChangedListener onNetworkStatusChangedListener) {
            ...
            UtilsBridge.runOnUiThread(new Runnable() { // from class: com.shix.shixipc.utilcode.NetworkUtils.NetworkChangedReceiver.1
                @Override // java.lang.Runnable
                public void run() {
        ...
        public void unregisterListener(final OnNetworkStatusChangedListener onNetworkStatusChangedListener) {
            ...
            UtilsBridge.runOnUiThread(new Runnable() { // from class: com.shix.shixipc.utilcode.NetworkUtils.NetworkChangedReceiver.2
                @Override // java.lang.Runnable
                public void run() {
                    int size = NetworkChangedReceiver.this.mListeners.size();
    ...
    public static final class WifiScanResults {
        ...
        public List<ScanResult> filterResults = new ArrayList();
    ...
    public static void addOnWifiChangedConsumer(final Utils.Consumer<WifiScanResults> consumer) {
        ...
        UtilsBridge.runOnUiThread(new Runnable() { // from class: com.shix.shixipc.utilcode.NetworkUtils.7
            @Override // java.lang.Runnable
            public void run() {
    ...
    public static Utils.Task<String> getDomainAddressAsync(final String str, Utils.Consumer<String> consumer) {
        return UtilsBridge.doAsync(new Utils.Task<String>(consumer) { // from class: com.shix.shixipc.utilcode.NetworkUtils.6
    ...
    public static Utils.Task<String> getIPAddressAsync(final boolean z, Utils.Consumer<String> consumer) {
        return UtilsBridge.doAsync(new Utils.Task<String>(consumer) { // from class: com.shix.shixipc.utilcode.NetworkUtils.5
            @Override // com.shix.shixipc.utilcode.ThreadUtils.Task
            public String doInBackground() {
    ...
    public static Utils.Task<Boolean> isAvailableAsync(Utils.Consumer<Boolean> consumer) {
        return UtilsBridge.doAsync(new Utils.Task<Boolean>(consumer) { // from class: com.shix.shixipc.utilcode.NetworkUtils.1
            @Override // com.shix.shixipc.utilcode.ThreadUtils.Task
    ...
    public static Utils.Task<Boolean> isWifiAvailableAsync(Utils.Consumer<Boolean> consumer) {
        return UtilsBridge.doAsync(new Utils.Task<Boolean>(consumer) { // from class: com.shix.shixipc.utilcode.NetworkUtils.4
            @Override // com.shix.shixipc.utilcode.ThreadUtils.Task
            public Boolean doInBackground() {
    ...
    public static void removeOnWifiChangedConsumer(final Utils.Consumer<WifiScanResults> consumer) {
        ...
        UtilsBridge.runOnUiThread(new Runnable() { // from class: com.shix.shixipc.utilcode.NetworkUtils.9
            @Override // java.lang.Runnable
            public void run() {
    ...
    public static void startScanWifi() {
        ...
        timer.schedule(new TimerTask() { // from class: com.shix.shixipc.utilcode.NetworkUtils.8
            ...
            public void run() {
                ...
                UtilsBridge.runOnUiThread(new Runnable() { // from class: com.shix.shixipc.utilcode.NetworkUtils.8.1
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    public static Utils.Task isAvailableByDnsAsync(final String str, Utils.Consumer<Boolean> consumer) {
        return UtilsBridge.doAsync(new Utils.Task<Boolean>(consumer) { // from class: com.shix.shixipc.utilcode.NetworkUtils.3
            @Override // com.shix.shixipc.utilcode.ThreadUtils.Task
            public Boolean doInBackground() {
    ...
    public static Utils.Task<Boolean> isAvailableByPingAsync(final String str, Utils.Consumer<Boolean> consumer) {
        return UtilsBridge.doAsync(new Utils.Task<Boolean>(consumer) { // from class: com.shix.shixipc.utilcode.NetworkUtils.2
            @Override // com.shix.shixipc.utilcode.ThreadUtils.Task
            public Boolean doInBackground() {
