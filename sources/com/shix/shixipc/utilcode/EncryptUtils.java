...
public final class EncryptUtils {
    ...
    public static byte[] encryptHmacSHA1(byte[] bArr, byte[] bArr2) {
        return hmacTemplate(bArr, bArr2, HmacSHA1Signature.ALGORITHM);
    }
    ...
    public static byte[] rc4(byte[] bArr, byte[] bArr2) {
        ...
        byte[] bArr4 = new byte[RecyclerView.c0.FLAG_TMP_DETACHED];
        ...
        for (int i4 = 0; i4 < 256; i4++) {
            i3 = (i3 + bArr3[i4] + bArr4[i4]) & ViewfinderView.OPAQUE;
            byte b2 = bArr3[i3];
            bArr3[i3] = bArr3[i4];
            bArr3[i4] = b2;
        }
        ...
        for (int i6 = 0; i6 < bArr.length; i6++) {
            i5 = (i5 + 1) & ViewfinderView.OPAQUE;
            i3 = (i3 + bArr3[i5]) & ViewfinderView.OPAQUE;
            byte b3 = bArr3[i3];
            bArr3[i3] = bArr3[i5];
            bArr3[i5] = b3;
            bArr5[i6] = (byte) (bArr3[(bArr3[i5] + bArr3[i3]) & ViewfinderView.OPAQUE] ^ bArr[i6]);
        }
        return bArr5;
    }

    public static byte[] rsaTemplate(byte[] bArr, byte[] bArr2, int i2, String str, boolean z) {
        if (bArr != null && bArr.length != 0 && bArr2 != null && bArr2.length != 0) {
            try {
    ...
    */
    public static byte[] encryptMD5File(java.io.File r4) {
        ...
        L55:
            goto L54
        */
        throw new UnsupportedOperationException("Method not decompiled: com.shix.shixipc.utilcode.EncryptUtils.encryptMD5File(java.io.File):byte[]");
    }
