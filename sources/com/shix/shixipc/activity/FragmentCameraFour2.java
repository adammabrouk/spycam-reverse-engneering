...
import com.shix.shixipc.activity.FragmentCameraFour2;
...
public class FragmentCameraFour2 extends BaseFragment implements NUIMainActivity.PlayFramgent2Interface {
    public String did;
    ...
    private void initView(View view) {
        ...
        NUIMainActivity.setPlayFramgent2Interface(this);
        ImageButton imageButton = (ImageButton) view.findViewById(R.id.ib_fragment_add);
        this.ibAdd = imageButton;
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: c.h.a.a.y
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentCameraFour2.this.a(view2);
            }
        });
        final TextView textView = (TextView) view.findViewById(R.id.tv_pause);
        this.glVideo.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.shix.shixipc.activity.FragmentCameraFour2.1
            @Override // android.view.View.OnLongClickListener
            public boolean onLongClick(View view2) {
                FragmentCameraFour2.this.llFragmentFourCenter.setVisibility(0);
                if (FragmentCameraFour2.this.isPause) {
                    textView.setText(FragmentCameraFour2.this.mAty.getResources().getString(R.string.Play));
                } else {
                    textView.setText(FragmentCameraFour2.this.mAty.getResources().getString(R.string.Pause));
                }
                return false;
            }
        });
        view.findViewById(R.id.tv_disconnect).setOnClickListener(new View.OnClickListener() { // from class: c.h.a.a.w
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentCameraFour2.this.b(view2);
            }
        });
        textView.setOnClickListener(new View.OnClickListener() { // from class: c.h.a.a.z
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentCameraFour2.this.c(view2);
            }
        });
    }
    ...
    private void writeSample(final byte[] bArr, final int i2, final int i3) {
        ...
        if (handler != null) {
            handler.post(new Runnable() { // from class: c.h.a.a.x
                @Override // java.lang.Runnable
                public final void run() {
                    FragmentCameraFour2.this.a(bArr, i2, i3);
                }
            });
        }
    }
    ...
    @Override // com.shix.shixipc.activity.NUIMainActivity.PlayFramgent2Interface
    ...
    public void onDestroyView() {
        ...
        NUIMainActivity.setPlayFramgent2Interface(null);
        Handler handler = this.mHandle;
        if (handler != null) {
