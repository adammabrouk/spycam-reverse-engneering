...
import com.shix.shixipc.activity.FragmentCameraFour1;
...
public class FragmentCameraFour1 extends BaseFragment implements NUIMainActivity.PlayFramgent1Interface {
    public String did;
    ...
    private void initView(View view) {
        ...
        NUIMainActivity.setPlayFramgent1Interface(this);
        ImageButton imageButton = (ImageButton) view.findViewById(R.id.ib_fragment_add);
        this.ibAdd = imageButton;
        imageButton.setOnClickListener(new View.OnClickListener() { // from class: c.h.a.a.v
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentCameraFour1.this.a(view2);
            }
        });
        final TextView textView = (TextView) view.findViewById(R.id.tv_pause);
        this.glVideo.setOnLongClickListener(new View.OnLongClickListener() { // from class: com.shix.shixipc.activity.FragmentCameraFour1.1
            @Override // android.view.View.OnLongClickListener
            public boolean onLongClick(View view2) {
                FragmentCameraFour1.this.llFragmentFourCenter.setVisibility(0);
                if (FragmentCameraFour1.this.isPause) {
                    textView.setText(FragmentCameraFour1.this.mAty.getResources().getString(R.string.Play));
                } else {
                    textView.setText(FragmentCameraFour1.this.mAty.getResources().getString(R.string.Pause));
                }
                return false;
            }
        });
        view.findViewById(R.id.tv_disconnect).setOnClickListener(new View.OnClickListener() { // from class: c.h.a.a.u
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentCameraFour1.this.b(view2);
            }
        });
        textView.setOnClickListener(new View.OnClickListener() { // from class: c.h.a.a.s
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentCameraFour1.this.c(view2);
            }
        });
    }
        ...
        if (handler != null) {
            handler.post(new Runnable() { // from class: c.h.a.a.t
                ...
                public final void run() {
                    FragmentCameraFour1.this.a(bArr, i2, i3);
                }
            });
        }
    }
    ...
    @Override // com.shix.shixipc.activity.NUIMainActivity.PlayFramgent1Interface
    ...
    public void onDestroyView() {
        ...
        NUIMainActivity.setPlayFramgent1Interface(null);
        Handler handler = this.mHandle;
        if (handler != null) {
