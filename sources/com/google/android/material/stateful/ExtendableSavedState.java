...
public class ExtendableSavedState extends AbsSavedState {
    ...
    public final g<String, Bundle> f10600c;
    ...
    public String toString() {
        return "ExtendableSavedState{" + Integer.toHexString(System.identityHashCode(this)) + " states=" + this.f10600c + "}";
    }
    ...
    public void writeToParcel(Parcel parcel, int i2) {
        ...
        for (int i3 = 0; i3 < size; i3++) {
            strArr[i3] = this.f10600c.c(i3);
            bundleArr[i3] = this.f10600c.e(i3);
        }
    ...
    public ExtendableSavedState(Parcel parcel, ClassLoader classLoader) {
        ...
        this.f10600c = new g<>(readInt);
        for (int i2 = 0; i2 < readInt; i2++) {
            this.f10600c.put(strArr[i2], bundleArr[i2]);
        }
    }
}
