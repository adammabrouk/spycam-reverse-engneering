...
public class OSSUtils {
    ...
    public static void signRequest(RequestMessage requestMessage) throws Exception {
        ...
        if (requestMessage.isAuthorizationRequired()) {
            ...
            requestMessage.getHeaders().put(HttpHeaders.AUTHORIZATION, sign);
        }
    }
