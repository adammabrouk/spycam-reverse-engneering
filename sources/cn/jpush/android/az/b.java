...
public class b {
    ...
    public static final Object f9450a = new Object();

    /* renamed from: b, reason: collision with root package name */
    public static Queue<String> f9451b;
    ...
    */
    public static org.json.JSONArray a(android.content.Context r3) {
        /*
            ...
            cn.jpush.android.r.b.b(r0, r1)     // Catch: java.lang.Throwable -> L2c
        ...
        L4a:
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.jpush.android.az.b.a(android.content.Context):org.json.JSONArray");
    }
    ...
    public static void a(Context context, List<String> list) {
        try {
            ...
            cn.jpush.android.r.b.b("NotificationRecords", "saveString=" + jSONArray2);
            Sp.set(context, Key.NotiCancel().set(jSONArray2));
        } catch (Throwable th) {
            cn.jpush.android.r.b.f("NotificationRecords", "save NotiCancel e:" + th);
        }
    }

    public static boolean a(Context context, String str) {
        b(context);
        return f9451b.contains(str);
    }
        ...
        try {
            ...
            if (a2 != null && a2.length() != 0) {
                    ...
                    if (currentTimeMillis < jSONObject.getLong("time") + JConstants.DAY) {
                        ...
                        if (!z) {
                            ...
                            if (!TextUtils.isEmpty(str) && str.equals(string)) {
                                cn.jpush.android.l.c.a(context, str, 1032, 3);
                            } else if (!TextUtils.isEmpty(str2)) {
                                if (str2.equals(string)) {
                                    cn.jpush.android.l.c.a(context, str, 1033, 3);
                                }
                            }
                            z = true;
                        }
                ...
                if (jSONArray.length() != a2.length()) {
                    String jSONArray2 = jSONArray.length() > 0 ? jSONArray.toString() : null;
                    cn.jpush.android.r.b.b("NotificationRecords", "saveString when check=" + jSONArray2);
                    Sp.set(context, Key.NotiCancel().set(jSONArray2));
                }
                return z;
            }
            ...
            cn.jpush.android.r.b.f("NotificationRecords", "isAlreadyCancel e:" + th);
            return false;
        }
    }
    ...
    public static void b(Context context, String str) {
        try {
            ...
            synchronized (f9450a) {
                ...
                Iterator<String> it = f9451b.iterator();
                while (it.hasNext()) {
                    sb.append(it.next() + ",");
                }
            ...
            cn.jpush.android.r.b.h("NotificationRecords", "saveNotiHistory failed,messageId = " + str);
        }
    }
}
