...
public class ByteBufferUtils {
    ...
    public static final String TAG = "ByteBufferUtils";

    public static String generalExtraStr(Throwable th, JResponse jResponse, ByteBuffer byteBuffer) {
    ...
    */
    ...
    public static void onException(Throwable th, JResponse jResponse, ByteBuffer byteBuffer) {
