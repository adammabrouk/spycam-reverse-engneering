...
public abstract class BaseLogger {
    ...
    private void log(int i2, boolean z, String str, String str2, Throwable th) {
        JCoreManager.onEvent(null, getCommonTag(), 18, str, null, Integer.valueOf(i2), Boolean.valueOf(z), str2, th);
    }
